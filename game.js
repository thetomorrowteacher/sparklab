...
function vPodium(){
  ...
  return '<div style="text-align:center"><img src="' + LOGO + '" alt="" style="display:block;margin:0 auto;height:90px;width:auto"><div class="df title-xl">🏁 ' + (done.length ? "We have a winner!" : "Race Results") + '</div>' +
